...
const LineChart3D = forwardRef(({ importingData }, ref) => {
  ...
  async function init() {
    ...
    function createLineGraphs(data) {
...
export default memo(LineChart3D, (prevProps, nextProps) => {
