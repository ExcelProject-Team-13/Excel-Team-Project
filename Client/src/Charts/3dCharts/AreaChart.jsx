...
import AreaChart3D from "./scripts/AreaScript"
...
const AreaChart = () => {
   ...
   return (
        <div className="w-[100vw] overflow-x-hidden relative pt-7 md:px-10 px-4 pb-10">
            ...
            <h1 className="text-3xl w-full text-center font-bold mb-5">Area CHART</h1>
            <div className="w-full flex xl:flex-row flex-col justify-evenly gap-7 items-center h-[60%]">
                <div className="flex justify-center items-center w-[60%] h-[550px]">
                    <div className="md:w-[750px] sm:w-[550px] w-[400px] h-[293.3px] md:h-[550px] sm:h-[403px] shadow-[0_0_10px_5px_#144da8] "><AreaChart3D ref={chartRef} importingData={Data} /></div>
                </div>
