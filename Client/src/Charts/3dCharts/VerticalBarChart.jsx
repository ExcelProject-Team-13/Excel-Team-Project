...
import ExcelReader from "../input";
import ".styles/page.css";
import BarChart3D from "./scripts/VerticalScript";
...
const BarChart = () => {
    ...
    const [Data, setData] = useState({
        ...
        series: [
            { name: "may", color: "#3a7bd5", values: [199, 249] },
            { name: "apr", color: "#00d2ff", values: [189, 220] },
            { name: "jun", color: "#f46b45", values: [136, 150] }
        ]
    });
    ...
    useEffect(() => {
        handleExcelData({
            isValid: true,
            title: dummyData.title, // without file extension
    ...
    return (
        <div className="w-[100vw] overflow-x-hidden relative pt-7 md:px-10 px-4 pb-10">
            ...
            <div className="instructions absolute w-full h-[99vh] md:md:top-[45%] top-[5%] overflow-hidden z-50 hidden justify-center items-center ">
            ...
            <h1 className="text-3xl w-full text-center font-bold mb-5">VERTICAL BAR CHART</h1>
            <div className="w-full flex xl:flex-row flex-col justify-evenly gap-7 items-center h-[60%]">
                <div className="flex  justify-center items-center w-[60%] h-[550px]">
                    <div className="md:w-[750px] sm:w-[550px] w-[400px] h-[293.3px] md:h-[550px] sm:h-[403px] shadow-[0_0_10px_5px_#144da8] "><BarChart3D ref={chartRef} importingData={Data} /></div>
                </div>
                <div className="xl:w-[40%] w-full flex flex-col flex-wrap justify-center items-center gap-3">
                    <div className="flex justify-center items-center md:w-[452px] w-[90%] flex-wrap border gap-3 border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#144da8]">
                        ...
                        <input name="title" type="text" placeholder="Title"
                            value={dummyData.title ?? "Bar Chart"}
                            ...
                            {dummyData.labels.map((label, index) => (
                                <div key={index} className="relative flex justify-center items-center bg-[#144da8] border border-y-[#144da8] border-white">
                                    ...
                                    <button
                                        ...
                                        className="absolute w-[30px] h-[30px] top-1 md:right-2 right-[-4px] text-white"
                                    >
                                        <Trash size={16} />
                                    </button>
                                </div>
