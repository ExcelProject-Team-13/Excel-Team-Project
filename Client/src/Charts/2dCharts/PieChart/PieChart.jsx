...
const PieChart = () => {
    ...
    return (
        <div className="w-[100vw] overflow-x-hidden h-full p-6">
            <h1 className="text-3xl w-full text-center font-bold mb-5">Pie CHART</h1>
            <div className="w-full flex justify-evenly gap-7 items-center h-[60%]">
                <div className="flex justify-center items-center w-[70%] h-[550px]"><Pie className="rounded-[20px] shadow-[0px_0px_8px_0px_black]"
                                            ...
                                            <Draggable key={index} draggableId={String(index)} index={index}>
                                                {(provided) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="px-4 border-b border-r border-[#144da8] flex justify-between items-center gap-2 p-2 hover:bg-gray-100">
                                                            <input
                                                                type="number"
                                                                className="text-center w-full focus:outline-none"
                                                        ...
                                                        <div className="px-4 border-b relative border-[#144da8] row flex justify-center items-center gap-2 p-2 hover:bg-gray-100">
                                                            <input
                                                                type="color"
                    ...
                    <div className="w-[50%] flex flex-col justify-center items-center gap-3">
                        <div className="flex justify-center items-center gap-4">
                            ...
                            <div className="flex justify-center items-center w-[220px] flex-wrap border gap-3 border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#144da8]">
                                ...
                                <input name="offset" type="number" min={0} max={70} step={5}
                                    value={offset ?? 5}
                                    className="w-[80px] focus:outline-none"
                                    onChange={(e) => {
                        ...
                        <div className="flex justify-center items-center gap-4">
                            <div className="flex justify-evenly items-center w-[220px] border border-gray-300 rounded-md px-1 py-2 focus:outline-none focus:ring-2 focus:ring-[#144da8]">
                                <label className="text-lg font-semibold" htmlFor="Opacity">Pie Opacity</label>
