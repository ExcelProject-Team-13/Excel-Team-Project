    ...
    return (
        <div className="w-full min-h-screen p-4 md:p-6 overflow-x-hidden">
            ...
            <div className="w-full flex flex-col xl:flex-row justify-center items-center gap-4 md:gap-7">
                ...
                <div className="w-full xl:w-[40%] px-7 xl:px-4 flex flex-col justify-center items-start gap-3 p-4 rounded-lg">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-2 w-full">
                        <div className="w-fit flex flex-wrap justify-center items-center gap-4">
                            <button
                                onClick={addRow}
                                className="w-full sm:w-48 button flex gap-2 justify-center items-center px-4 py-2  text-white rounded-md ransition"
                            >
                        ...
                        <div className="w-fit flex flex-wrap justify-center items-center gap-4">
                            <button className="w-full sm:w-48 button flex gap-2 justify-center items-center px-4 py-2  text-white rounded-md  transition">
...
export default HorzontalBarChart;