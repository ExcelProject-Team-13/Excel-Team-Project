...
const BarChart = () => {
    ...
    const options = {
        ...
        scales: { y: { max: YScale[1], min: YScale[0], ticks: { precision: 0 } } }
    };
    ...
    return (
        <div className="w-[100vw] overflow-x-hidden h-full p-6">
            <h1 className="text-3xl w-full text-center font-bold mb-5">BAR CHART</h1>
            <div className="w-full flex justify-evenly gap-7 items-center h-[60%]">
                <div className="flex justify-center items-center w-[70%] h-[550px]"><Bar width={750} className="rounded-[20px] shadow-[0px_0px_8px_0px_black]"
                    height={550} ref={chartRef} data={data} options={options} plugins={[customCanvasBackgroundColor]} /></div>
            ...
            <div className=" mt-6">
                ...
                <div className="w-[80%] mx-auto flex justify-center items-center gap-4">
                                        ...
                                        {Data.map((item, index) => (
                                            <Draggable key={index} draggableId={String(index)} index={index}>
                                                {(provided) => (
                                                    ...
                                                    >
                                                        <div className="px-4 p-2  border-r border-[#144da8] hover:bg-gray-100">
                                                            <input
                                                                type="text"
                                                        ...
                                                        <div className="px-4  flex justify-between items-center gap-2 p-2 border-r border-[#144da8] hover:bg-gray-100">
                                                            <input
                                                                type="number"
                                                                className="text-center w-full focus:outline-none"
                                                        ...
                                                        <div className="px-4 row flex relative justify-center items-center gap-2 p-2 hover:bg-gray-100">
                                                            <input
                                                                type="color"
                                                            ...
                                                            />
                                                            <Trash className="trash-icon absolute right-7" onClick={() => deleteRow(index)} />
                                                        </div>
                                                    </div>
                                                )}
                                            </Draggable>
                    ...
                    <div className="w-[50%] flex flex-col justify-center items-center gap-3">
                        ...
                        <div className="flex justify-center items-center w-[452px] flex-wrap border gap-3 border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-[#144da8]">
                            <h1 className="w-[100px] text-xl font-semibold">Y axis:</h1>
                        ...
                        <div className="flex justify-center items-center gap-4">
                            ...
                            <div className="flex justify-evenly items-center w-[220px] border border-gray-300 rounded-md px-1 py-2 focus:outline-none focus:ring-2 focus:ring-[#144da8]">
                                <label className="text-lg font-semibold" htmlFor="hoveropacity">Hover Opacity</label>
                                <input name="hoveropacity" type="number" min="0" max="1" step="0.01"
                                    value={HoverOpacity}
                                    onChange={(e) => {
